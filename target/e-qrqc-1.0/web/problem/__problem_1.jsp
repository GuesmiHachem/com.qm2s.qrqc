    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="w3-container w3-round w3-white w3-border w3-padding1">

                    <div class="row">
                        <div class="col-lg-3 col-12">
                            <div class="w3-panel w3-light-gray w3-round w3-padding w3-border ">
                                <%if (user.getPicture().equals("")) {%>
                                <img width="23px" height="23px" class="w3-left w3-margin-right photo w3-image w3-circle" src="<%=application.getContextPath()%>/img/profile/user.png" alt="...">
                                <%} else {%> 
                                <img width="23px" height="23px" class="w3-left w3-margin-right photo w3-image w3-circle" src="<%=application.getContextPath()%>/img/profile/<%=user.getPicture()%>" alt="...">
                                <%}%> 
                                <span class="w3-medium"><%=problem.getIdUser().getName() + " " + problem.getIdUser().getFirstName()%></span>
                            </div>
                        </div>

                        <div class="col-lg-2 col-12">
                            <div class="w3-panel w3-light-gray w3-round w3-padding w3-border">
                                <span class="w3-medium"><%=problem.getStatus()%></span>
                            </div>
                        </div>

                        <div class="col-lg-2 col-12">
                            <div class="w3-panel w3-light-gray w3-round w3-padding w3-border ">
                                <span class="w3-medium"><%=problem.getCode()%></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-12">
                            <div class="w3-panel w3-light-gray w3-round w3-padding w3-border">
                                <span class="w3-medium" style="color: <%=typeProblem.getColor()%>"><%=problem.getIdTypeProblem().getName()%></span>
                            </div>
                        </div>

                        <div class="col-lg-3 col-12">
                            <button data-toggle="modal" data-target="#Step1ViewListUser" type="button" class="w3-panel w3-light-gray w3-round w3-padding w3-border"><%=problem.getIdStep1().getStep1ViewList().size()%>  Vues <i class="fa fa-eye"></i></button>
                        </div>
                ...
                <div class="card w3-border w3-border-gray">
                    <div class="card-content "> 
                        <div  class="<%=Design.containerTitle%> w3-padding-small ">
                            <div class="w3-left">
                                <h4 class="<%=Design.textTitle%>">Caractérisation</h4>
                            </div>
                            <div class="w3-right">
