...
<script src="<%=application.getContextPath()%>/assets/js/jquery-v1.min.js"></script>
<script src="<%=application.getContextPath()%>/assets/js/jquery.custom-file-input.js"></script>
