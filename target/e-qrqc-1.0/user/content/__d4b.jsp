                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="card text-white bg-dark mb-3">
                            <div class="card-header">
                                ISHIKAWA POUR LA NON DETECTION / ISHIKAWA FOR THE NON DETECTION
                            </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card mb-3 ">
                                            <div class="card-header text-dark bg-warning shadow">
                                                <small class="form-text font-weight-bold"> 
                                                    5 POURQUOI POUR LA NON DETECTION : 1er facteur
                                                </small>
                                                <small class="form-text font-weight-bold text-white"> 
                                                    5 WHYS FOR THE NON DETECTION: 1rst factor
                                                </small>
                                            </div>
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="card mb-3 ">
                                            <div class="card-header text-dark bg-warning shadow">
                                                <small class="form-text font-weight-bold"> 
                                                    5 POURQUOI POUR LA NON DETECTION : 2er facteur
                                                </small>
                                                <small class="form-text font-weight-bold text-white"> 
                                                    5 WHYS FOR THE NON DETECTION: 2nd factor
                                                </small>
                                            </div>
                                            <div class="card-body text-dark bg-white shadow">
                                                <!--================================================-->
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="card mb-3 ">
                                            <div class="card-header text-dark bg-warning shadow">
                                                <small class="form-text font-weight-bold"> 
                                                    5 POURQUOI POUR LA NON DETECTION : 3ème facteur
                                                </small>
                                                <small class="form-text font-weight-bold text-white"> 
                                                    5 WHYS FOR THE NON DETECTION: 3rd factor
                                                </small>
                                            </div>
                                            <div class="card-body text-dark bg-white shadow">
                                                <!--================================================-->
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="card mb-3 ">
                                            <div class="card-header text-dark bg-warning shadow">
                                                <small class="form-text font-weight-bold"> 
                                                    5 POURQUOI POUR LA NON DETECTION : 4ème facteur
                                                </small>
                                                <small class="form-text font-weight-bold text-white"> 
                                                    5 WHYS FOR THE NON DETECTION: 2rd factor
                                                </small>
                                            </div>
                                            <div class="card-body text-dark bg-white shadow">
                                                <!--================================================-->
