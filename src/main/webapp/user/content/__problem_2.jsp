...
<div class="row">
    <div class="col-md-12">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="w3-row">
                            <div class="col-lg-12">
                                <div class="card  mb-3">
                                    <div class="card-header">
                                        Qui doit être Alerté <span class="w3-badge w3-round w3-pink"> <%=listStep1AlertShould.size()%></span>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card  mb-3">
                                    <div class="card-header">
                                        Qui peut être Alerté <span class="w3-badge w3-round w3-pink"> <%=listStep1AlertCan.size()%></span>
                                    </div>
                                    <ul class="list-group list-group-flush">
                                        <%
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <table  class="w3-table w3-border w3-border-blue-gray  table-bordered w3-card-4 " cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tbody>
                                            <%
                                                for (Step1Securisation step1Securisation : listStep1SecurityPlan) {
                                            %>
        ...
        <div class="card mb-3">
            <div  class="card-header">
                Analyse et actions définitives
            </div>
            <div class="card-body">   
                <div class="w3-col-12"> 
                    <div class="row">
